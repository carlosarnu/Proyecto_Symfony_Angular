 ...
 */
final class Version20260225163408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tarea (id SERIAL NOT NULL, titulo VARCHAR(180) NOT NULL, descripcion TEXT DEFAULT NULL, estado VARCHAR(20) NOT NULL, fecha_creacion TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, fecha_limite TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
