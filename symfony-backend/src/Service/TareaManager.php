...
class TareaManager
{
    ...
    /**
     * Nuevo método: lista únicamente tareas pendientes.
     */
...
/***********************************************Validación opcional de fechas*****************************************************/
        $this->validarFechas($fechaCreacion, $fechaLimite);
...
/**************************************************************************************************************************************/
    public function actualizar(Tarea $tarea, array $payload): Tarea
    {
        ...
        $nuevaFechaLimite = isset($payload['fechaLimite'])
            ? new \DateTime($payload['fechaLimite'])
            : $tarea->getFechaLimite();

/*******************Validación usando la fecha de creación original***********************************************************/
        $this->validarFechas($tarea->getFechaCreacion(), $nuevaFechaLimite);
...
/****************************************************************************************************************************************/
     ...
     */
    private function validarFechas(\DateTimeInterface $fechaCreacion, ?\DateTimeInterface $fechaLimite): void
    {
